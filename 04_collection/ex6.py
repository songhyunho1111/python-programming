...
result = {x : x ** 2 for x in range(1, 10, 2)}
print(result)
...
result = {k: words.count(k) for k in set(words)} 
print(result)
...
result = {k: "합격" if v >= 90 else "불합격" for k,v in scores.items()}
...
print(x for x in stock.keys() | incoming.keys())

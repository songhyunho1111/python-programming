...
# print(dir(1))                      # int 자료형이 제공하는 속성과 메소드 목록
...
# print(s.index("Crong"))            # 인덱스 반환 ( 없으면 )
...
# print("123".isnumeric())              # 숫자이면 True | 한자, 로마자 가능 !!
